...
const FileUploadPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-red-400 to-purple-800 text-gray-200 flex items-center justify-center relative overflow-hidden">
      <motion.div
      ...
      >
        ...
        <div className="px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center">
          <p className="text-sm text-gray-400">
            Need help?{" "}
            <a href="/support" className="text-gray-200 hover:underline">
              Contact Support
            </a>
          </p>
        </div>
